...
public class AlignmentSizeOffsetImpl implements AlignmentSizeOffset {
    ...
    public AlignmentSizeOffsetImpl(int x, int y, int width, int height, float scale, @NotNull Alignments alignment) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return x == other.x && y == other.y && width == other.width && height == other.height && Float.compare(scale, other.scale) == 0 && alignment.equals(other.alignment);
    }

    @Override
    public int hashCode() {
        return Objects.hash(x, y, width, height, scale, alignment);
    }
